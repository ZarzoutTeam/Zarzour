...
return [
    ...
    'coupon_customer_usage_limit_reached' => 'This phone number has reached the coupon usage limit.',
    'coupon_phone_required' => 'A phone number is required to validate this coupon.',
    'coupon_phone_mismatch' => 'This coupon is reserved for another customer.',
    'coupon_below_minimum' => 'The order amount is below the minimum required to use this coupon.',
